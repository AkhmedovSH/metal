<template>
	<div class="mt96">
		...
		<div class="position-relative arched_hangars_bg">
			...
			<div class="position-absolute page-px about-img-content">
				...
				<p class="color-2">
				В арочном ангаре может быть естественное освещение, конструкция <br>
				допускает любое количество окон, в любом месте.
				</p>
			</div>
		</div>
		...
		<div class="page-px pt-5 bg-2">
			...
			<div class="section-breadcrumbs mb-5">
				<span class="mr-4">Материалы</span>
				<img src="@/assets/images/line.png" alt="1">
			</div>
			<div class="section-2-title">
				При стрроительстве ангаров применяются;
			</div>
		...
		<div class="row no-gutters">
				...
				<div class="page-px my-5">
					...
					<div class="media-body">
						<p class="mb-5"><span class="ml-4"></span> 
							...
							применяется ЛСТК. Арочные ангары выгодны в плане <br>
							расхода материала.
						</p>
						...
						<table class="table">
							...
							<tbody>
								<tr>
									<td>Высота</td>
									<td>4,5 - 12 м <br>(половина ширины площади)</td>
								</tr>
							</tbody>
						</table>
					</div>
			...
			<div class="col-lg-6 col-md-12">
				<div>
					<img src="@/assets/images/hangars/arched/section_2.png" alt="">
				</div>
			</div>
		</div>
		...
		<div class="row no-gutters bg-1">
			<div class="col-lg-12 col-md-12">
				<div class="page-px my-5">
					<div class="section-breadcrumbs mb-5">
						Арочные ангары <span class="mx-3">/</span> Преимущества
					</div>
					<div class="section-2-title">
						Преимущества арочных ангаров
					</div>
					<hr class="mb-5">
		...
		<div class="page-px">
			...
			<div class="d-flex justify-content-between flex-wrap">
				<div class="media mb-5">
					...
					<div class="media-body">
						<h5 class="mb-5">Технические характеристики арочных ангаров</h5>
					</div>
				</div>
